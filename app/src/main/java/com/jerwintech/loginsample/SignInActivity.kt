...
class SignInActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val hintColor = resources.getColor(R.color.dark_blue)
        ...
        passwordLayout.hintTextColor = ColorStateList.valueOf(hintColor)
        emailLayout.hintTextColor = ColorStateList.valueOf(hintColor)
